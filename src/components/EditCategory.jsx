...
export const EditCategory = ({close, fetchCategory, data: categoryData}) => {
                ...
                <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
                    <div className='grid gap-1'>
                        ...
                        <input 
                           ...
                           className='bg-blue-50 p-2 border border-blue-10 focus-within:border-primary-200 outline-none rounded'
                        />
                    </div>
                    ...
                    <button className={
                        `${data.name && data.image ? "bg-primary-200 hover:bg-primary-100" : "bg-gray-300"} py-2 font-semibold `
                    }>
                        Update Category
                    </button>
                </form>
